...
export default function TambahJemaatPage() {
  ...
  const onSubmit = async (data: JemaatFormData) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error?.message || 'Gagal menambahkan jemaat')
      }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Tambah Jemaat Baru</h1>
        <p className="text-gray-600 mt-1">
          Isi formulir di bawah untuk menambahkan jemaat baru
        </p>
      </div>
